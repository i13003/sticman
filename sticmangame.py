__author__ = 'Tanaka Yasuto <n15011@std.it-college.ac.jp>'
...
def colliede_top(co1, co2):
    return (within_x(co1, co2) and
            co2.y1 <= co1.y1 <= co2.y2)


def colliede_bottom(y, co1, co2):
    return (within_x(co1, co2) and
...
class StickFigureSprite(Sprite):
    ...
    def move(self):
        ...
        for sprite in self.game.sprites:
            ...
            if top and self.y < 0 and colliede_top(co, sprite_co):
                self.y = -self.y
                top = False
            if bottom and self.y > 0 and colliede_bottom(self.y,
                                                         co, sprite_co):
            ...
            if  bottom and falling and self.y == 0  \
                    ...
                    and colliede_bottom(1, co, sprite_co):
                falling = False
